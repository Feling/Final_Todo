    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
        ...
        <div class="panel panel-default" >
            <div class="panel-heading">
                <div class="panel-title text-center">Edit Item</div>
            </div>     

            <div class="panel-body" >
			<br/>
                <form name="form" id="form" name="form" method="get" action="/TodoProject/Controller/addItem">
                   	<input type="hidden" name="userID" value=<%=userID%>/>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                        <input id="itemtitle" type="text" class="form-control" name="itemTitle" value="" placeholder="Title">                                        
                    </div>

                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
                        <input id="itemDescription" type="text" class="form-control" name="itemDescription" placeholder="Description">
                    </div>                                                                  

                    <div class="form-group">
                        <!-- Button -->
                        <div class="col-sm-12 controls">
                            <button type="submit" href="#" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-log-in"></i>Change</button>                          
                        </div>
                    </div>
