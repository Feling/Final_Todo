    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
        ...
        <div class="panel panel-default" >
            <div class="panel-heading">
                <div class="panel-title text-center">Update Item</div>
            </div>     

            <div class="panel-body" >
                <form name="form" id="form" name="form" method="get" action="/TodoProject/Controller/updateitem">
                   
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                        <input id="username" type="text" class="form-control" name="itemTitle" value="" placeholder="<%=itemOldTitle%>">                                        
                    </div>

                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-book"></i></span>
                        <input id="itemDescription" type="text" class="form-control" name="itemDescription" placeholder="<%=itemOldDescription%>">
                    </div>                                                                  
