...
<html>
<head>
<jsp:useBean id="user_db" class="main.java.table.User" scope="session"></jsp:useBean>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
 <link rel="stylesheet" type="text/css" href="/TodoProject/bootstrap/css/style.css"/>
...
<body>
Hello, <jsp:getProperty name="user_db" property="username"/> 
<%
	...
	/*	if (null == userName) {
		   request.setAttribute("userMessage", "Session has ended.  Please login.");
		   RequestDispatcher rd = request.getRequestDispatcher("/TodoProject/Controller/loginpage");
                                                ...
                                                <div class="navbar-footer">
                                                    <div class="navbar-footer-content">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                            <form action="/TodoProject/Controller/logout" method="get">
																	<input type="submit" class="btn btn-default btn-sm pull-right" value="Logout" />
																	</form>
...
for(Item td : todolist){
	...
	<tr>
		...
		<td><%=td.getDescription() %></td>
		  <td class="text-center"><form action="/TodoProject/Controller/updateItemPage" method="get"><input type="hidden" name="itemID" value="<%=String.valueOf(td.getItemid())%>"/><input type="submit" class='btn btn-info btn-xs' class="glyphicon glyphicon-edit" value="Edit"/></form></a> 
		  <form action="/TodoProject/Controller/deleteItem" method="get"><input type="hidden" name="itemID" value="<%=String.valueOf(td.getItemid())%>"/><input type="submit" class='btn btn-danger btn-xs' class="glyphicon glyphicon-remove" value="Delete"/></form></a> </td>
	
<%-- <input type="hidden" name="itemID" value="<%=String.valueOf(td.getItemid())%>"/> --%>
<%-- <input type="submit" class="btn" value="<%=td.getItemid()%>"/> --%>
<!-- </form> -->
		</tr>
		<%
}%>
